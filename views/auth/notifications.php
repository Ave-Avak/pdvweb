...
<div class="max-w-3xl mx-auto">
    ...
    <?php if (empty($notifications)): ?>
        <div class="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-2">Aucune notification</h2>
            <p class="text-gray-600">
                Vous serez prévenu(e) ici quand quelque chose d'important se passera :
                nouveau message, changement de statut d'une commande, ou réponse à un commentaire.
            </p>
        </div>
    <?php else: ?>
        <div class="space-y-2">
