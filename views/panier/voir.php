...
<div class="max-w-4xl mx-auto">
    ...
    <!-- Indicateur de sauvegarde automatique (membres connectés uniquement) -->
    <?php if (Auth::estConnecte() && !empty($detail['lignes'])): ?>
        <div class="bg-success-50 border border-success-200 rounded-lg p-3 mb-4 flex items-start gap-3">
            ...
            <div class="text-sm text-success-800">
                ...
                Votre sélection est conservée même après déconnexion : vous la retrouverez à votre prochaine visite.
            </div>
        </div>
    <?php elseif (!Auth::estConnecte() && !empty($detail['lignes'])): ?>
        <div class="bg-info-50 border border-info-200 rounded-lg p-3 mb-4 flex items-start gap-3">
            ...
            <div class="text-sm text-info-800">
                ...
                <a href="<?= url('/login.php') ?>" class="font-semibold underline">connectez-vous</a>
                pour sauvegarder votre panier et le retrouver depuis n'importe quel appareil.
            </div>
        </div>
    <?php endif; ?>
